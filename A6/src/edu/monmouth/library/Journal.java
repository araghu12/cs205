...
public class Journal implements LibraryItem, Comparable<Journal> {
    ...
    public int compareTo(Journal other) {
        System.out.println("Journal.compareTo() invoked: [" + title + " vol=" + volume + "] vs [" + other.title + " vol=" + other.volume + "]");
        int titleCmp = this.title.compareTo(other.title);
    ...
    @Override
    public int hashCode() {
        System.out.println("Journal.hashCode() used for: " + title + ", editor=" + editor + ", volume=" + volume);
        int result = 1;
